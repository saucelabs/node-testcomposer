...
The minimum `sauce-test-report.json` file, which can be generated by [sauce-json-reporter](https://github.com/saucelabs/sauce-json-reporter-js/), to populate the test case list on Sauce Labs web UI:
